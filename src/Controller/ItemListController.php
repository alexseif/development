...
class ItemListController extends AbstractController
{
    ...
    public function new(Request $request, ItemListRepository $itemListRepository): Response
    {
    ...
    public function edit(Request $request, ItemList $itemList, ItemListRepository $itemListRepository): Response
    {
        $form = $this->createForm(ItemListType::class, $itemList);
        $form->handleRequest($request);
    ...
    public function delete(Request $request, ItemList $itemList, ItemListRepository $itemListRepository): Response
    {
        if ($this->isCsrfTokenValid('delete' . $itemList->getId(), $request->request->get('_token'))) {
            $itemListRepository->remove($itemList);
        }
